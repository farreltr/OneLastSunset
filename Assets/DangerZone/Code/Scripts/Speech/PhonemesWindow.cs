...
namespace AC
{
	...
	public class PhonemesWindow : EditorWindow
	{
		...
		private List<string> SetDefaults (LipSyncMode mode)
		{
			...
			else if (mode == LipSyncMode.FromSpeechText)
			{
				phonemes.Add ("A/I");
				phonemes.Add ("E");
				phonemes.Add ("O");
				phonemes.Add ("U");
				phonemes.Add ("M/B/P");
				phonemes.Add ("C/D/G/K/N/R/S/Th/Y/Z");
				phonemes.Add ("L");
				phonemes.Add ("F/V");
				phonemes.Add ("W/Q");
			}
			else if (mode == LipSyncMode.ReadSapiFile)
			{
				phonemes.Add ("B/M/P/ ");
				phonemes.Add ("AY/AH/IH/EY/ER");
				phonemes.Add ("G/OO/OH/W");
				phonemes.Add ("SH/R/Z/SF/D/L/F/TN/K/N/NG/H/X");

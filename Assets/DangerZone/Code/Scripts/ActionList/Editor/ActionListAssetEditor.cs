...
public class ActionListAssetEditor : Editor
{
	...
	public static Action RebuildAction (AC.Action action, int number, ActionListAsset _target)
	{
	...
	public static Action RebuildAction (AC.Action action, int number, ActionListAsset _target, ResultAction _resultAction, int _skipAction, ActionListAsset _linkedAsset, Cutscene _linkedCutscene)
	{
		ActionsManager actionsManager = AdvGame.GetReferences ().actionsManager;
	...
	public static void ResetList (ActionListAsset _targetAsset)
	{
		...
		{
			foreach (Action _action in _targetAsset.actions)
			{
				ActionListAssetEditor.DeleteAction (_action, _targetAsset);
			}

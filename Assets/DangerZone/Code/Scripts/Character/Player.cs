	...
	public class Player : Char
	{
		...
		private void FixedUpdate ()
		{
			...
			if (activePath && !pausePath)
			{
				...
				else if ((stateHandler && stateHandler.gameState == GameState.Cutscene && !lockedPath) || 
				         (settingsManager && settingsManager.movementMethod == MovementMethod.PointAndClick) || 
				         (settingsManager && settingsManager.movementMethod == MovementMethod.StraightToCursor && settingsManager.singleTapStraight) || 
				         IsMovingToHotspot ())
				{

...
public class ActionDialogueSystemConversation : Action
{
	...
	public ActionDialogueSystemConversation ()
	{
		...
		title = "Third-Party: Dialogue System conversation";
	}
	...
	override public void ShowGUI ()
	{
		...
		conversation = EditorGUILayout.TextField(new GUIContent("Conversation Title:", "The title defined in the dialogue database"), conversation);

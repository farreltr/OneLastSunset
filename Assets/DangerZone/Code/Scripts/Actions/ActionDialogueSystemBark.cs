...
public class ActionDialogueSystemBark : Action
{
	...
	public ActionDialogueSystemBark ()
	{
		...
		title = "Third-Party: Dialogue System bark";
	}
	...
	override public void ShowGUI ()
	{
		...
		conversation = EditorGUILayout.TextField(new GUIContent("Bark Conversation Title:", "The title defined in the dialogue database"), conversation);

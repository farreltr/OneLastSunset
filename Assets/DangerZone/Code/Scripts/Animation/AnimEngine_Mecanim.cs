...
public class AnimEngine_Mecanim : AnimEngine
{
	...
	public override void CharSettingsGUI ()
	{
		...
		if (AdvGame.GetReferences () && AdvGame.GetReferences ().speechManager && AdvGame.GetReferences ().speechManager.lipSyncOutput == LipSyncOutput.PortraitAndGameObject && character.GetShapeable ())
		{

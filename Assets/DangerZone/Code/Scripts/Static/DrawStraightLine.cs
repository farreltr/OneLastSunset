...
public class DrawStraightLine
{
	...
	{
		Draw (new Vector2 (rect.x, rect.y - offset), new Vector2 (rect.x + rect.width+1, rect.y - offset), color, width, false);
		...
		Draw (new Vector2 (rect.x, rect.y + rect.height + offset), new Vector2 (rect.x + rect.width+1, rect.y + rect.height + offset), color, width, false);
	}

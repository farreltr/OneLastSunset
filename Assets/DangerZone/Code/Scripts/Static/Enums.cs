...
namespace AC
{
	...
	public enum HighlightState { None, Normal, Flash, Pulse };
	...
	public enum LipSyncMode { Off, FromSpeechText, ReadPamelaFile, ReadSapiFile, FaceFX };
	public enum LipSyncOutput { Portrait, PortraitAndGameObject };

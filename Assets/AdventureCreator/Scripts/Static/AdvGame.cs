...
namespace AC
{
	...
	public class AdvGame : ScriptableObject
	{
		...
		/**
		 * <summary>Converts a scene name to nothing, if scenes are being referenced by number.</summary>
		 * <param name = "chooseSceneBy">How scenes are being referenced (name or number)</param>
		 * <param name = "sceneName">The name of the scene</param>
		 * <returns>The name of the scene, or nothing if the scene is referenced by number</returns>
		 */

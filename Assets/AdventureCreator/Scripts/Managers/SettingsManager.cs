...
namespace AC
{
	...
	public class SettingsManager : ScriptableObject
	{
		...
		/** If True, then the currently-selected inventory item will not be shown in a MenuInventoryBox */
		...
		/** How much of the screen will be searched for a suitable NavMesh, if the user doesn't click directly on a NavMesh (it movementMethod = AC_MovementMethod.PointAndClick)  */

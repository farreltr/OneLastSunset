...
namespace AC
{
	...
	public class Player : Char
	{
		...
		/**
		 * <summary>Checks if the Player can be controlled directly at this time.</summary>
		 * <returns>True if the Player can be controlled directly at this time</returns>
		 */
